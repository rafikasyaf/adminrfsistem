          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href=#><i class="fa fa-pencil"></i><span>Master Data</span><i class="fa fa-angle-right"></i></a>
              <ul class="treeview-menu">
                ...
                <li class="active"><a href="{{url('admindevice')}}"><i class="fa fa-inbox"></i>Devices</a></li>
              </ul>
              </li>
    ...
    <!-- END sidenav -->
      <div class="content-wrapper">
        <div class="page-title">
            <h2><i class="fa fa-inbox"></i> Add Device</h2>
      ...
      <div class="col-md-9 personal-info">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="text" name="id_rf" placeholder="Rf Id" value="{{(isset($data->id_rf))?$data->id_rf:''}}">
              @if ($errors->has('id_rf'))
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="text" name="brand" placeholder="Brand" value="{{(isset($data->brand))?$data->brand:''}}">
              @if ($errors->has('brand'))
                  <span class="invalid-feedback" role="alert" style="color: red">
          ...
          <div class="form-group">
            <label class="col-lg-3 control-label">Property of:</label>
            <div class="col-lg-8">
              <input class="form-control" type="text" name="property" placeholder="Property" value="{{(isset($data->property))?$data->property:''}}">
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <select class="form-control nav" name="station" placeholder="Station" value="{{(isset($data->station))?$data->station:''}}">
                      <option value="picker">Dispatch 1</option>
                      <option value="checker">Dispatch 2</option>
                      <option value="rr">Receiving</option></select>
          ...
          <div class="form-group">
            ...
            <div class="col-lg-8">
              <input class="form-control" type="text" name="status" placeholder="Status" value="{{(isset($data->status))?$data->status:''}}">
