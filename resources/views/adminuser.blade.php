    ...
    <!-- END sidenav -->
      <div class="content-wrapper">
        <div class="page-title">
            <h2><i class="fa fa-users"></i> Operators</h2>
            <div><br>
...
<!-- import export add -->         
            ...
            <div class="exportexcel">
              <a class="btn btn-edit" href="{{ url('adminuser_export') }}"><i class="fa fa-file-excel-o"></i> Export to Excel</a>
              <a class="btn btn-primary" href="{{url('adduser')}}"> Add</a>

              <form  action="{{ url('import_adminuser') }}" class="form-horizontal pull-left" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
                ...
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td>{{$v['id_sap']}}</td>
                      <td>
                        <a class="btn btn-edit" href="{{action('AdminUserController@edit', $v['nik'])}}">Edit </a>
                        <!-- <a class="btn btn-danger" href="{{url('adminuser/'.$v['nik'].'/delete')}}">Delete </a> -->
                      </td>
                      </tr>
                      @endforeach
                  </tbody>
