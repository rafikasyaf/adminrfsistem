          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview"><a href=#><i class="fa fa-pencil"></i><span>Master Data</span><i class="fa fa-angle-right"></i></a>
              <ul class="treeview-menu">
                <li><a href="{{url('adminrf')}}"><i class="fa fa-user-o"></i>RF Admin</a></li>
                <li class="active"><a href=""><i class="fa fa-id-card"></i>SAP Operators</a></li>
                <li><a href="{{url('adminuser')}}"><i class="fa fa-users"></i>Operators</a></li>
                <li><a href=""><i class="fa fa-inbox"></i>Devices</a></li>
              </ul>
              </li>
    ...
    <!-- END sidenav -->
      <div class="content-wrapper">
        <div class="page-title">
            <h2><i class="fa fa-inbox"></i> SAP Operators</h2> 
        <div><br>
...
<!-- import export add --> 
            ...
            <div class="exportexcel">
              ...
              <a class="btn btn-edit" href="{{ url('admindevice_export') }}"><i class="fa fa-file-excel-o"></i> Export to Excel</a>
              <a class="btn btn-primary" href="{{url('addsap')}}"> Add</a>

              <form  action="{{ url('import_admindevice') }}" class="form-horizontal pull-left" method="post" enctype="multipart/form-data">
              {{ csrf_field() }}
              ...
              <div class="">
                <table class="table table-hover table-bordered" id="sampleTable">
                  ...
                  <tbody>
                    ...
                    <td>{{$v['brand']}}</td>
                    <td>
                      <a class="btn btn-edit" href="{{action('AdminDeviceController@edit',$v['id_rf'])}}">Edit </a>
                      <!-- <a class="btn btn-danger" href="{{url('admindevice/'.$v['id_rf'].'/delete')}}">Delete </a> -->
                    </td>
                    </tr>
                    @endforeach
                  </tbody>
