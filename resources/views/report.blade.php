      ...
      <aside class="main-sidebar hidden-print">
        <section class="sidebar">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="active"><a href="{{url('report')}}"><i class="fa fa-folder"></i><span>Report</span></a></i>
              <!-- <ul class="treeview-menu">
                <li class="active"><a href=""><i class="fa fa-file-excel-o"></i>Data Transaction</a></li>
              </ul> -->
    ...
    <!-- END sidenav -->
      <div class="content-wrapper">
        <div class="page-title">
            <h2><i class="fa fa-users"></i> Data Transaction</h2>
            <div>
...
<!--               <div class="custom-select" value="{{(isset($data->category))?$data->category:''}}">
            ...
            <form action="{{ url('report/export') }}" method="get" class="form-inline" enctype="multipart/form-data">
