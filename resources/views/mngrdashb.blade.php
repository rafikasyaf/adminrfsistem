...
<!-- Sidebar Menu-->
          <ul class="sidebar-menu">
            <li  class="active"><a href="{{url('mngrdashb')}}"><i class="fa fa-tachometer"></i><span>Dashboard</span></a></li>
            <li><a href="{{url('mngrreport')}}"><i class="fa fa-folder"></i><span>Report</span></a></li>
          </ul>
        </section>
      </aside>
